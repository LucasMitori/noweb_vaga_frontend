...
const GlobalStyle = createGlobalStyle`
    ...
    cel: (11) 9-7749-2121
    Name: Vaga Front-end noweb
    Description: Global Styles for Noweb Project
  ...
  :root{
    /* Colors */
    --color-primary: #FBAF17;
    --color-secondary: #202332;
    --color-tertiary: #1F2860;
    --color-bg: #FFFFFF;
    ...
    --font-primary-montserrat: 'Montserrat';
